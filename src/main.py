...
class ImageConverter:
    def __init__(self):
        self._MESH_PATH = '/home/szymon/catkin_ws/src/camera_node_v4/src/box_mesh_v3.stl' if os.environ.get(
            'USER') == 'szymon' else '/home/szymon/catkin_ws/src/camera_node_v4/src/box_mesh_v3.stl'  # TODO: correct path for server
